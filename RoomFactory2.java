...
public class RoomFactory
{
	...
	public static HashMap<String, Room> getRooms()
	{
		...
		tempRoom = new Room("L1001",
				...
				+ " \nin the room have power. There's a crowbar lying on the floor next to you.", true, af.getAllArtifacts().get("Crowbar"));
		...
		tempRoom = new Room("L1010",
				...
				false,ZombieFactory.getAllZombies().get("M02") ,af.getAllArtifacts().get("Mop Handle"));
		rooms.put(tempRoom.getRoomID(), tempRoom);
		...
		tempRoom = new Room("L2002",
				...
				+ "\nwhen out falls a woman in a nurse’s uniform. She groans hideously..",
		...
		tempRoom = new Room("L2005","The grass here is wet with dew."
				...
				+ "While doing so, you spot what looks to be a first-aid kit.",
				false,af.getAllArtifacts().get("First-Aid Kit"));
		rooms.put(tempRoom.getRoomID(), tempRoom);
		...
		tempRoom = new Room("L2010",
				...
				+ "\nfound an ally. The doctor turns and starts towards you- slow, but gradually speeding up.", false,ZombieFactory.getAllZombies().get("M04"),
